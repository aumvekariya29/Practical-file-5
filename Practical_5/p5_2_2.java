...
public class p5_2_2
{
    public static void main(String[] args) throws IOException
    {
        ...
        try
        {
            sourceStream = new FileInputStream("/Users/aumvekariya/Documents/java/Practical_5/character.txt");
            targetStream = new FileOutputStream ("/Users/aumvekariya/Documents/java/Practical_5/byte.txt");
